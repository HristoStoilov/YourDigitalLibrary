...
from services.book_service import (
    get_books,
    get_book_detail,
    add_book as add_book_service,
    update_book,
    delete_book as delete_book_service,
    contact_submitter as send_contact_message
)
...
def books():
    ...
    books = get_books(page, search, author_filter)
...
def book_detail(book_id):
    book, reviews = get_book_detail(book_id)
...
def delete_book(book_id):
    ...
    delete_book_service(book)
    flash('Book deleted successfully!')
    return redirect(url_for('book.user_books'))


@book_bp.route("/user/contact_submitter/<int:book_id>", methods=['POST'])
@login_required
